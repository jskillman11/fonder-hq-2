...
// Admin-only in practice: since the 2026-07-16 migration, change_log's SELECT
// policy lets a client read their own program's *published* rows too, so this
// unfiltered draft-status query now returns real rows for a client-role
// caller instead of an empty array. Every caller of this function must gate
// on isAdmin itself (see get-program-data.js) — do not assume RLS blocks it.
